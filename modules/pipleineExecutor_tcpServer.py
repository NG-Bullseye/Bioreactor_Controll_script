...
class PipeLineExecutor:
    ...
    def apply_configuration(self, pid: int):
        logging.info('PIPELINE CONFIGURATION')
        if self.config.is_valid():
            self.configure_shell(pid)
